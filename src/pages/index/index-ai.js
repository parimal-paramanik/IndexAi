...
export default function IndexAi() {
    ...
    return (
        <>
                            ...
                            <div className="lg:me-6 lg:text-start text-center">
                                ...
                                {/* <div className="subcribe-form mt-6 mb-3">
                                    <form className="relative max-w-md mx-auto lg:ms-0">
                                        ...
                                        <div className="relative">
                                            <FaRegEnvelope className="me-2 text-base absolute top-4 left-5" />
                                            <input type="email" id="aiemail2" name="email2" className="py-4 pe-40 ps-12 w-full h-[50px] outline-none text-black dark:text-white rounded-md bg-white/60 dark:bg-slate-900/60 shadow dark:shadow-gray-800" placeholder="query" />
                                        </div>
            ...
            <h3 className=" md:text-[26px] md:leading-normal text-2xl leading-normal font-semibold text-center mb-8">Our Customers</h3>
                <div className="container relative">
                    <CompanyLogo />
                </div>
            </section>
            <section className="pt-6">
            <h3 className="mb-8 md:text-[26px] md:leading-normal text-2xl leading-normal font-semibold text-center">Ecosystem Partners</h3>
                <div className="container relative">
                    <CompanyLogo />
                </div>
            </section> */}
